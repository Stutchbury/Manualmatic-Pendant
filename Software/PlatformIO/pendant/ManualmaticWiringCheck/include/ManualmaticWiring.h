...
const uint8_t TOUCHSCREEN_YP = A6;  // Y+ must be an analog pin, use "An" notation!
const uint8_t TOUCHSCREEN_XM = A9;  // X- must be an analog pin, use "An" notation!
const uint8_t TOUCHSCREEN_YM = A8;  // Y- can be a digital pin
const uint8_t TOUCHSCREEN_XP = A7;  // X+ can be a digital pin
...
const uint8_t ENCODER_A_MPG = 4;      //MPG_A
const uint8_t ENCODER_B_MPG = 5;      //MPG_B
const uint8_t ENCODER_A_SPINDLE = 6;  //SPINDLE_A
const uint8_t ENCODER_B_SPINDLE = 7;  //SPINDLE_B
...
const uint8_t JOYSTICK_X = 38;        //JOY_X
const uint8_t JOYSTICK_Y = 39;        //JOY_Y
